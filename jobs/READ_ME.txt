...
It should contain a "data_out" folder with your output files. It will also contain a log file, that confirms
which sex markers for which species were used for the analysis.
...
what went wrong. You can move the job back to "prep" and work on correcting any issues there, then
